...
exports.register = function(req,res){
            ...
            if(info)
                ...
                RegisterAttendee.findOne({phoneno: phoneno,eventid:eventid},function (err, updatedinfo) {
                    ...
                    RegisterAttendee.update({phoneno: phoneno,eventid:eventid},{qrcode:updatedinfoforqr._id},function(err,tst){
                        ...
                        console.log(updatedinfoforqr);
                        /*request('https://elementsculmyca2017.herokuapp.com/api/v1/deliverETicket/'+updatedinfoforqr.email+'/'+updatedinfoforqr.fullname+'/'+updatedinfoforqr._id+'/'+updatedinfoforqr.eventid, function (error, response, body) {
    ...
    Event.findOne({_id: updatedinfoforqr.eventid},function(err, tst){
        ...
        '                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data='+updatedinfoforqr.qrcode+'" alt="" width="110" height="110" border="0" >'+
        '                      </td>'+
        '                      <td width="15">'+
        '                      </td></tr>'+
        '                    </tbody></table>'+
